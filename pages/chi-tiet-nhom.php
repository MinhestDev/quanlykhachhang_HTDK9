...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['luuNhanVien']))
  {
    ...
    // validate
    if($nhanVien == 'chon')
      $error['nhanVien'] = 'Vui lòng <b> chọn khách hàng </b>';
    ...
    if(mysqli_num_rows($resultKT) != 0)
      $error['tonTai'] = 'Khách hàng này <b> đã tồn tại </b> trong nhóm';
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        $success['success'] = 'Thêm khách hàng vào nhóm thành công';
  ...
  if(isset($_POST['delete']))
  {
    ...
    $success['success'] = 'Đã xóa khách hàng ra khỏi nhóm thành công.';
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Bạn có thực sự muốn xóa khách hàng này ra khỏi nhóm?
          </div>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Thêm khách hàng vào nhóm</h3>
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
              </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <option value="chon">--- Chọn khách hàng ---</option>
                      <?php
                        foreach ($nvhow as $nv) 
                        {
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='luuNhanVien'><i class='fa fa-plus'></i> Thêm khách hàng</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Khách hàng trong nhóm</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <?php 
