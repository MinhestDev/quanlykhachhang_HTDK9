    ...
    if(!$error)
    {
      if($hinhAnh)
      {
        ...
        if($result)
        {
          ...
          $success['success'] = 'Thêm khách hàng thành công';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="them-nhan-vien.php?p=staff&a=add-staff">khách hàng</a></li>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Thêm mới khách hàng</h3> &emsp;
            ...
            <div class="box-body">
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên khách hàng" name="tenNhanVien" value="<?php echo isset($_POST['tenNhanVien']) ? $_POST['tenNhanVien'] : ''; ?>">
                      <small style="color: red;"><?php if(isset($error['tenNhanVien'])){ echo "Tên khách hàng không được để trống"; } ?></small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <option value="chon">--- Chọn loại khách hàng ---</option>
                      <?php 
                      ...
                      <small style="color: red;"><?php if(isset($error['loaiNhanVien'])){ echo "Vui lòng chọn loại khách hàng"; } ?></small>
                    </div>
                    <div class="form-group">
                ...
                <?php 
                  if($_SESSION['level'] == 1)
                    echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Thêm mới khách hàng</button>";
                ?>
              </form>
            </div>
            <!-- /.box-body -->
