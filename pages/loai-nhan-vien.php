...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    // validate
    if(empty($typeName))
      $error['typeName'] = 'Vui lòng nhập <b> loại khách hàng </b>';
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        $success['success'] = 'Tạo loại khách hàng thành công';
  ...
  if(isset($_POST['delete']))
  {
    ...
    if($result)
    {
      $success['success'] = 'Xóa loại khách hàng thành công.';
      echo '<script>setTimeout("window.location=\'loai-nhan-vien.php?p=staff&a=employee-type\'",1000);</script>';
    }
  }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            Bạn có thực sự muốn xóa loại khách hàng này?
          </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="loai-nhan-vien.php?p=staff&a=employee-type">Loại khách hàng</a></li>
        <li class="active">Tạo loại khách hàng</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tạo loại khách hàng</h3>
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='save'><i class='fa fa-plus'></i> Tạo loại khách hàng</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
