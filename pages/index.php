	      ...
	      <div class="row">
	        <div class="col-lg-3 col-xs-6">
	          ...
	          <div class="small-box bg-aqua">
	            ...
	            <a href="danh-sach-nhan-vien.php?p=staff&a=list-staff" class="small-box-footer">Danh sách khách hàng <i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	        <div class="col-lg-3 col-xs-6">
	        ...
	        <div class="col-lg-3 col-xs-6">
	          ...
	          <div class="small-box bg-green">
	            ...
	            <a href="export-nhan-vien.php" class="small-box-footer">Danh sách khách hàng <i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	        <div class="col-lg-3 col-xs-6">
	          ...
	          <div class="small-box bg-green">
	            ...
	            <a href="export-bang-luong.php" class="small-box-footer">Lương khách hàng <i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	      </div>
