  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="danh-sach-nhan-vien.php?p=staff&a=list-staff">khách hàng</a></li>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Chỉnh sửa thông tin khách hàng</h3> &emsp;
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên khách hàng" name="tenNhanVien" value="<?php echo $row['ten_nv']; ?>">
