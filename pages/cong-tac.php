...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    if(mysqli_num_rows($resultCheck) != 0)
    {
      ...
      echo "<script>alert('Khách hàng này đang trong quá trình công tác');</script>";
    }
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Chọn khách hàng<span style="color: red;">*</span> : </label>
                      ...
                      <small style="color: red;"><?php if(isset($error['maNhanVien'])){ echo 'Vui lòng chọn khách hàng';} ?></small>
                    </div>
                    <div class="form-group">
